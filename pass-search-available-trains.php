 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Advanced Ambulance Search</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Ambulance</a></li>
              <li class="breadcrumb-item active">Advanced Ambulance Search</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Available Ambulance Details
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">R<?php echo $row->fare;?></td>
