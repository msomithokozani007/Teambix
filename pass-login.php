...
<head>
    ...
    <link rel="shortcut icon" href="assets\img\profile\logo-xxx.jpg">
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets\img\profile\logo-xxx.jpg" alt="logo" width="70" height="#{conf.logoHeight}"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2023 - <?php echo date ('Y');?> Online Ambulance Emergency System | Developed By Thokozani S Msomi</div>
          </div>
        </div>
      </div>
    </div>
