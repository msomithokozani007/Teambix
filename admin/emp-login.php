...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/param.ico">
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xxx.png" alt="logo" width="70" height="#{conf.logoHeight}"><span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
