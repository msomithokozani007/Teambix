 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Manage Medical</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Manage Medical</li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ)) {?>
              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        /*
                        *Lets get details of available Medical! !
                        */
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">R<?php echo $row->train_fare;?></td>
