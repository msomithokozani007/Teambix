              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-ambulance"></i><span>Ambulance</span></a>
                    ...
                    <ul class="sub-menu">
                       <li><a href="emp-add-train.php">Add Ambulance</a>
                       <li><a href="emp-manage-train.php">Manage Ambulance</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-account-switch"></i><span>Patient</span></a>
                    <ul class="sub-menu">
                      <li><a href="emp-add-passenger.php">Add Patient</a>
                      </li>
                      <li><a href="emp-manage-passengers.php">Manage Patient</a>
                      </li>
                      
                    </ul>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-account-check"></i><span>Paramedic</span></a>
                    <ul class="sub-menu">
                      <li><a href="admin-add-employee.php">Add Paramedic</a>
                      </li>
                      <li><a href="admin-manage-employee.php">Manage Paramedic</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-square-inc-cash"></i><span>Accounting</span></a>
                    <ul class="sub-menu">
                      <li><a href="emp-view-accounting.php"><span class="badge badge-success float-right">Medical Payments</span>View</a>
                      </li>
                    </ul>
                  </li>   
