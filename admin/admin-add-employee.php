	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Paramedic  Account Created";
			}
			else {
  ...
  <body>
	...
	<!--Log on to codeastro.com for more projects!-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Add Paramedic</h2>
          ...
          <div class="row">
			...
			<!--Log on to codeastro.com for more projects!-->
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Create Paramedic Profile<span class="card-subtitle">Fill All Details</span></div>
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="New Paramedic " name = "Create_Profile" type="submit">
