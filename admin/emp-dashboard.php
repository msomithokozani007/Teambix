      ...
      <div class="be-content">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">rowing</i></div>
                ...
                <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="desc">Emergency Ambulance</div>
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              <div class="widget widget-tile">
              <div class="chart sparkline"><i class="material-icons">man</i></div>
                <div class="data-info">
                <?php
                  //code for summing up number of passengers 
                  ...
                  $stmt->close();
                ?>
                  <div class="desc">Administrator's</div>
                  <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $pass;?>">0</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              ...
              <div class="chart sparkline"><i class="material-icons">loyalty</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                  <div class="desc">Approved medical</div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Ambulancess
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Paramedic List
