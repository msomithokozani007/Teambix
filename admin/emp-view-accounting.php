            ...
            <div class="col-12 col-lg-6 col-xl-6">
              ...
              <div class="chart sparkline"><i class="material-icons">attach_money</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                  ?>
                  <div class="desc">Paid Medical</div>
                  <div class="value">R<span class="number" data-toggle="counter" data-end="<?php echo $count_fare;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Medical Payment Status
