	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Patient's Account Has Been Created";
			}
			else {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Create Patient</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Create Patient Profile<span class="card-subtitle">Fill All Details</span></div>
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Create Patient " name = "Create_Profile" type="submit">
