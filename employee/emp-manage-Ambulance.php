...
if(isset($_GET['del']))
{
      ...
      $stmt->close();	 
        ...
        if($stmt)
        {
          $succ = "Ambulance Details Deleted";
        }
          else
          {
            $err = "Try Again Later";
              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        /*
                        *Lets get details of available Ambulance!!
                        */
                        $ret="SELECT * FROM orrs_train  "; //sql code to get all details of Ambulance.
