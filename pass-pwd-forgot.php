        ...
        <div class="main-content container-fluid">
          <div class="splash-container forgot-password">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xxx.png" alt="logo" width="70" height="#{conf.logoHeight}"><span class="splash-description">Forgot your password?</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Online Ambulance Emergency System | Developed By Thokozani S Msomi</div>
        </div>
      </div>
    </div>
