          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Canel Your Ambulance Booking                 
                </div>
                <div class="card-body">
