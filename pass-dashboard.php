            ...
            <div class="col-12 col-lg-6 col-xl-4">
              <a href="pass-my-booked-train.php">
                <div class="widget widget-tile">
                  <div class="chart sparkline"><i class="material-icons">add_booking_cart</i></div>
                  <div class="data-info">
                    <div class="desc">Booked Ambulance</div>
                  </div>
                </div>
              </a>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Available Ambulance
